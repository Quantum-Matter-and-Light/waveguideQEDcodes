function [Fi,mfi,omega_ff,Fi_easy,p_index,FF,alpha1_coeff,alpha2_coeff]=groundstate_shift()
ep0=8.85e-12;
hbar=1.05457148e-34;
c=299792458;
I=7/2;
...
jj_ps_sq=((3*pi*ep0*hbar*c^3)./(omega_ps.^3).*(1./(jj_factor)).*gamma_ps); %Note: polarizability unit conversion (SI --> MEEP)

function [Xplot,Yplot,Ex,Ey,Ez]=Efieldplot_Y_Normal(SILresult,nresult,ftrap)
close all
...
[Xplot,Yplot]=meshgrid(SILresult.x,SILresult.z);
...
caxis(ax1,[0 1])
hold on
%[C H2]=contourf(Xplot*10^6,Yplot*10^6,Nx,[0.8 1])
hold off
...
saveas(A,['Ix_XZ' num2str(lambda,4) 'nm.png'])
...
saveas(B,['Iy_XZ' num2str(lambda,4) 'nm.png'])
...
saveas(G,['Iz_XZ' num2str(lambda,4) 'nm.png'])
